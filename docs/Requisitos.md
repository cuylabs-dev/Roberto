...
| `BLOB_TTL_DAYS` | — | Default **10** — borra blobs más viejos (cuota Hobby) |
| `BLOB_CLEANUP_ON_RUN` | — | `true` = purga al inicio de `preparador.js` |
...
**Política:** Los kits/maquetas alojados en Vercel Blob tienen un **TTL estricto de 10 días** para proteger la cuota del plan Hobby. Scripts: `scripts/limpiar_blob.js`, `lib/blobCleanup.js`.
