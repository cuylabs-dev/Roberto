...
export function buildLeadContextBlock(lead) {
  ...
  return [
    ...
    lead.pitch_angle ? `Angulo venta (usar): ${lead.pitch_angle}` : "",
    lead.social?.bio || lead.bio ? `Bio Instagram/web: ${lead.social?.bio || lead.bio}` : "",
...
- PROHIBIDO copy de holding multinacional: "Lider en su industria", "Peru y LATAM", "+500 colaboradores", "5 paises", "lineas de negocio", "contribuimos a mejorar vidas", "decadas de experiencia regional".
- Cada servicio/plan/item DEBE ser especifico del rubro y coherente con la categoria Maps y las palabras clave de reseñas.
- Menciona el nombre real del negocio al menos en headline, quienes_somos o un testimonio.
