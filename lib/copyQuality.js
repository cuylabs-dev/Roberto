...
const BANNED_RE =
  /servicio\s*(principal|\d|uno|dos|tres|1|2|3)\b|producto\s*\d|item\s*\d|plan\s*\d\b|placeholder|lorem\s+ipsum|texto\s+de\s+ejemplo|nombre\s+del\s+negocio|tu\s+negocio\b|servicio\s+gen[eé]rico|consulta\s+general\s*$/i;
