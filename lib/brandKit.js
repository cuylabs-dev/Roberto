...
export function buildBrandKit(lead, evalResult, social = {}) {
  ...
  const template = evalResult.template || lead.template || rubro.template || "corporativo";
  ...
  const kit = {
    ...
    nicho: lead.nicho || rubro.nicho,
    rubroId: rubro.id,
    webPlatform: rubro.webPlatform,
    email: lead.email || null,
    blocks: evalResult.blocks?.length ? evalResult.blocks : rubro.blocks,
